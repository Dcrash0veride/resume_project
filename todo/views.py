...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm(), 'error': 'One or more fields incorrectly filled out.' })
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'todo':todo, 'form':form, 'error': 'One or more fields incorrectly filled out.'})
